...
function SuporteMonitorLista(){
    const [data, setData] = useState([]);
    const [opt, setOpt] = useState("SuporteMonitor")
    ...
    return(
        <div className="container">
            <div className="upper_line">
                <h1>Suporte Monitor Lista</h1>
                <a href="/suporte-monitor-reg">+ Adicionar Novo</a>
            </div>
            <div className="form">
                <table>
                    <tr>
...
export default SuporteMonitorLista